...
const chartConfig = {
  backgroundGradientFrom: '#081A25',
  backgroundGradientTo: '#0C2A3D',
  backgroundGradientFromOpacity: 1,
  backgroundGradientToOpacity: 1,
  color: (opacity = 1) => `rgba(10, 186, 181, ${opacity})`,
  labelColor: (opacity = 1) => `rgba(231, 241, 245, ${opacity})`,
  strokeWidth: 2,
  barPercentage: 0.6,
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    alignItems: 'center',
    borderTopWidth: 1,
    borderTopColor: '#124157',
    borderBottomWidth: 1,
    borderBottomColor: '#124157',
